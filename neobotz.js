...
const hxz = require('./baileys/hxz-api')
...
const { smsg, formatp, tanggal, formatDate, getTime, isUrl, sleep, clockString, runtime, fetchJson, getBuffer, jsonformat, format, parseMention, getRandom } = require('./baileys/myfunc')
const { aiovideodl } = require('./baileys/scraper.js')
...
sendOrder(m.chat, teks, "5123658817728409", fs.readFileSync('./media/image/logo.jpg'), 2022, "Lol Hanz+ ~ Multi Device", "6283155687629@s.whatsapp.net", "AR7zJt8MasFx2Uir/fdxhkhPGDbswfWrAr2gmoyqNZ/0Wg==", "99999999999999999999")
}
...
const fakey = (teks) => {
mans.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `Join Jadi Hengker 😎`,"body": `Join Bot's Official GC`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./settings/neobotz.jpg`),"sourceUrl": "https://chat.whatsapp.com/E3zewfxrc5pKE6Rzb3BuqG"}}}, { quoted: m})
}
const ftextt = {
key: { 
fromMe: false,
...
- Dan Lain Lain.
- Bisa Di Sewa Kan Kembali

*❏ List Harga Script Bot*
_Script Bronze : Rp25.000_
_Script Silver : Rp35.000_
_Script Premier : Rp50.000_

> *Keterangan Script Bot*
- Bronze : Script MD + Fitur 250+
- Silver : Script MD + Fitur 350+
- Premier : Script MD + Fitur 500+

_MD = Multi Device ( Support All Hp )_

*❏ List Harga Rdp :*
_Rdp : 35k RAM 4GB /1 VCpu_
_Rdp : 60k Ram 8GB/2 VCpu_
_Rdp : 90k Ram 16GB/4 VCpu_
_Rdp : 140k Ram 32GB/ 8 VCpu_
_Rdp : 190k Ram 64GB/16 VCpu_

_SSD ALL RDP : 126 GB SSD_
...
Saya *${namebot}*, Assisten *HanzBotOfficial* Bot Ini Adalah Beta Multi-Device WhatsApp.
Jika Ada Fitur Error Atau Bug Segera Lapor Ke Develover Botz
─────────────
────[ 𝙄𝙣𝙛𝙤 𝙐𝙨𝙚𝙧 ]────✧
> 𝘜𝘴𝘦𝘳𝘯𝘢𝘮𝘦 : *${pushname}!*
> 𝘓𝘪𝘮𝘪𝘵 𝘜𝘴𝘦𝘳 : *${global.db.users[m.sender].limit}*
> 𝘙𝘰𝘭𝘦 𝘜𝘴𝘦𝘳 : *${role}*
────────────
────[ 𝙄𝙣𝙛𝙤 𝘽𝙤𝙩𝙯 ]────✧
> 𝘕𝘢𝘮𝘢 𝘉𝘰𝘵 : *${global.namebot}*
> 𝘛𝘢𝘯𝘨𝘨𝘢𝘭 𝘚𝘦𝘳𝘷𝘦𝘳 : *${jangwak}*
> 𝘋𝘢𝘵𝘢𝘣𝘢𝘴𝘦 𝘉𝘰𝘵 : *MongoDB*
> 𝘞𝘢𝘬𝘵𝘶 𝘚𝘦𝘳𝘷𝘦𝘳 : *${time}*
> 𝘜𝘴𝘦𝘳𝘴 𝘚𝘦𝘳𝘷𝘦𝘳 : *${jumlahUser}*
> 𝘗𝘳𝘦𝘧𝘪𝘹 𝘚𝘵𝘢𝘵𝘶𝘴 : *(Multi Prefix)*
────────────
────[ 𝙄𝙣𝙛𝙤 𝙊𝙬𝙣𝙚𝙧 ]────✧
> 𝘕𝘢𝘮𝘢 : *${global.ownername}*
...
> 𝘞𝘪𝘵𝘢 : *${moment().utcOffset('+0800').format('HH:mm')}*
> 𝘞𝘪𝘵 : *${moment().utcOffset('+0900').format('HH:mm')}*
────────────
────[  𝙄𝙣𝙛𝙤 𝙋𝙚𝙣𝙜𝙜𝙪𝙣𝙖 ]────✧
> 𝘓𝘪𝘣𝘳𝘢𝘳𝘺 : *Baileys-Md*
...
mans.send5ButImg(m.chat, `${require('./message/help.js').donate(prefix, l, pushname)}`, `© 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 _Hanz_`, qris, btnR)
}
break
...
mans.send5ButImg(m.chat, `${require('./message/help.js').sewabot(prefix, l, pushname)}`, `© 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 _Hanz_`, sewabot, btnD)
}
break
case 'iklan':
{
...
mans.send5ButImg(m.chat, ikln, `© 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 _Hanz_`, iklan, btnG)
}
break
case 'command':
...
mans.send5ButImg(m.chat, `${require('./message/help.js').help(prefix, l, pushname)}`, `© 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 _Hanz_`, thumbv, spow)
}
break
...
{ urlButton: { displayText: `Instagram`, url : `https://Instagram.com/Hanz24` } },
{ urlButton: { displayText: `☎️Contact Me`, url: `+62 857-8900-4732` } },
{ quickReplyButton: { displayText: `🏧 leaderboard`, id: 'leaderboard'} }
]
mans.sendMessage(m.chat, { caption: teksehmazeh, document: { url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pptx' }, mimetype: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', fileName: '© HanzBotMD', templateButtons: butRun, footer: `ingin Berpetualang Lagi`, mentions: [m.sender] })
}
break
case 'list': case 'menu': case 'help': case '?': 
mnu = await getBuffer(tb1)
{
let listbot = [{
urlButton: {
displayText: 'SOURCE CODE',
...
mans.send5ButImg(m.chat, listmn, `© 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 _Hanz_`, mnu, listbot)
}
break
case 'grupbot':
case 'groupbot':
...
case 'quotesimage':case 'qoutesimage':
   ...
   fakey(mess.wait)
  mans.sendMessage(m.chat, { image: { url: cok }, caption: 'Done By HanzSlemek' }, { quoted: m })
  break
...
if (!m.isGroup) return m.reply(mess.group)
if (!isAdmins && !isCreator) return m.reply(mess.admin)
mans.sendMessage(m.chat, { text : `${require('./database/virtex.js').virtexfax(prefix, l, pushname)}`, mentions: participants.map(a => a.id)}, { quoted: m })
mans.sendMessage(m.chat, { text : `${require('./database/virtex.js').virtexfax(prefix, l, pushname)}`, mentions: participants.map(a => a.id)}, { quoted: m })
mans.sendMessage(m.chat, { text : `${require('./database/virtex.js').virtexfax(prefix, l, pushname)}`, mentions: participants.map(a => a.id)}, { quoted: m })
mans.sendMessage(m.chat, { text : `${require('./database/virtex.js').virtexfax(prefix, l, pushname)}`, mentions: participants.map(a => a.id)}, { quoted: m })
mans.sendMessage(m.chat, { text : `${require('./database/virtex.js').virtexfax(prefix, l, pushname)}`, mentions: participants.map(a => a.id)}, { quoted: m })
...
sendOrder(m.chat, teks, "5123658817728409", fs.readFileSync('./media/image/logo.jpg'), 2022, "Lol Hanz+ ~ Multi Device", "6283155687629@s.whatsapp.net", "AR6NCY8euY5cbS8Ybg5Ca55R8HFSuLO3qZqrIYCT7hQp0g==", "99999999999999999999")
} else if (sizny > 50) {
await mans.groupAcceptInvite(vcc).then(async(res) => m.reply(jsonformat(res))).catch(_ => _)
m.reply("Succes")
} else {
...
'+344+146',
jangbare,
'./database/hasilnulis.jpg'
])
.on('error', () => m.reply('Error') )
.on('exit', () => {
mans.sendMessage(from, {image:fs.readFileSync('./database/hasilnulis.jpg'), caption:'Succes'}, {quoted:m}).catch(() => m.reply('```「 GAGAL 」Terjadi kesalahan dalam mengirim file```'))
})
exec(`npm i marker`)
}
break
...
mans.setStatus(`Mode : Public Created By Hanz`)
}
break
case 'setstatut':
case 'setbio':
...
mans.setStatus(`Mode : Self Created By Hanz`)
}
break
case 'cekapikey':
if (!isCreator) return m.reply(mess.owner)
cekapi =`*Apikey Bot Saat ini adalah*\n_» ${lolkey} «_`
m.reply(cekapi)
break
case 'gantiapikey':
...
if (!isCreator) return m.reply(mess.owner)
tb1 = q
mans.sendMessage(from, {image:{url:tb1}, caption:`*Sukses Ganti Thumbnail Menu Bot*`}, {quoted:m})
}
break
break
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"Lol Hanz+ - Twitter Downloader",
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"Lol Hanz+ - Facebook Downloader",
...
mans.sendMessage(m.chat, {document: yy, mimetype: 'application/pdf', fileName: `iqra${text}.pdf By Hanz`}, {quoted:m}).catch ((err) => m.reply(oh))
}
break
case 'juzamma': {
if (args[0] === 'pdf') {
...
case 'pinterest': {
 if (isLimit < 1) return reply("Limit kamu sudah habis , silahkan beli dengan cara #buy limit _jumlah_")
     ...
     m.reply(`Satu limit terpakai\nSisa limit kamu : ${global.db.users[m.sender].limit}`)
    fakey(mess.wait)
let { pinterest } = require('./baileys/scraper')
